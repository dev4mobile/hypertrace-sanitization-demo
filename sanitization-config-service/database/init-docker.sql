...
COMMENT ON COLUMN sanitization_rules.condition IS 'JSON格式的规则条件配置，支持regex、key_keyword等类型';
...
BEGIN
    ...
    RAISE NOTICE '📋 Rules inserted: %', rule_count;
    RAISE NOTICE '⚙️ Configs inserted: %', config_count;
END $$;

...
# 启动 Spring Boot 应用 (PLAINTEXT 模式)
...
export OTEL_EXPORTER_OTLP_HEADERS='authorization=e049ab7e-dfa8-4d41-a539-642edcf2d050'
...
echo ""
echo "API 测试命令:"
echo "  创建用户: curl -X POST http://localhost:8080/api/users -H 'Content-Type: application/json' -d '{\"name\":\"张三\",\"email\":\"zhangsan@example.com\"}'"
